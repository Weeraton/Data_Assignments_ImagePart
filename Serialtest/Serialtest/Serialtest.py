...
def capture2():
    ...
    while isdone == 6:
            ...
            if img2 is not None:
                    isdone = img_process(img2)
                    print("isdon change to "+str(isdone))
    ...
    if mode ==1:
        ...
        for i in send :
            ...
            for j in i:
                ...
                print(bin(int(row/255)),end= ' ')
                packet = bytearray()
                packet.append(int(row/255))
        
                print(bin(row%255))
                packet2 = bytearray()
                packet2.append(int(row%255))
        

                print(bin(int(col/255)),end= ' ')
                packet = bytearray()
                packet.append(int(col/255))
        
                print(bin(col%255))
                packet2 = bytearray()
                packet2.append(int(col%255))
        

                print(bin(int(j/255)),end= ' ')
                packet = bytearray()
                packet.append(int(j/255))
        
                print(bin(j%255))
                packet2 = bytearray()
                packet2.append(int(j%255))
                col+=80
            row+=60
